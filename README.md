# Introduction
This article primarily introduces how to install SLAMTEC LIDAR ROS2 on the AIB-NW01 Ubuntu 20.04 environment provided by Avalue Technology Inc.
...
## Setp 3: Configure ROS2 Foxy, SLAMTEC LIDAR ROS2 Environment
```bash
# Setup ROS2 Foxy Environment
source /opt/ros/foxy/setup.bash
